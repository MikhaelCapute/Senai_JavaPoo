...
public class ControleDeClientes {
	...
	private void atualizarCliente() {
		...
		if(cliente != null) {
			...
			String nome = Teclado.lerTexto("Digite o novo nome ou ENTER para manter o atual:");
			if(nome.equals("")) {
				nome = cliente.getNome();
			}

			System.out.println("CPF atual: "+cliente.getCpf());
			String cpf = Teclado.lerTexto("Digite o novo CPF ou ENTER para manter o atual:");
			if(cpf.equals("")) {
				cpf = cliente.getCpf();
			}

			System.out.println("E-mail atual: "+cliente.getEmail());
			String email = Teclado.lerTexto("Digite o novo e-mail ou ENTER para manter o atual:");
			if(email.equals("")) {
	...
	public static void main(String[] args) {
		ControleDeClientes cdc = new ControleDeClientes();
		 int opcao = SAIR;
